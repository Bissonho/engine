...
class AppBootstrap {
  ...
  AppBootstrap(
      {required InitEngineFn initializeEngine, required Function runApp})
  ...
  FlutterEngineInitializer prepareEngineInitializer() {
    return FlutterEngineInitializer(
        ...
        // app runner object.
        initializeEngine: allowInterop((
                [JsFlutterConfiguration? configuration]) =>
  ...
  FlutterAppRunner _prepareAppRunner() {
    return FlutterAppRunner(
        runApp: allowInterop(([RunAppFnParameters? params]) {
