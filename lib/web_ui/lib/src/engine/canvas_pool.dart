...
//import 'html/picture.dart';  Remove HTML Code // Remove pictue.html
  ...
  void _createCanvas() {
    ...
    if (_reusablePool != null && _reusablePool!.isNotEmpty) {
      ...
      if (_canvas == null) {
        ...
        // reduceCanvasMemoryUsage(); Remove HTML Code
        canvas = _allocCanvas(_widthInBitmapPixels, _heightInBitmapPixels);
      }
      canvas!.style
        ..position = 'absolute'
    ...
    if (_context == null) {
      // reduceCanvasMemoryUsage(); Remove HTML Code // Remove pictue.html
      _context = canvas.context2D;
    }
    if (_context == null) {
